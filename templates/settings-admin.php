...
<div class="section" id="requestLicenseSection">
    ...
    <form name="licenserequestform" id="licenserequestform">
        ...
        <p>
            <div id="countrycode_error" class="errortext">Country is required</div>
    ...
    <div id="request_instructions" style="display: none;">
        <p>Copy the license text and paste it into an email to licenses@spreedbox.me to request the license.  You will receive an email reply containing the license string.</p>
        <button id="copytoclipboard">Copy to Clipboard</button>
    </div>
    
    <div id="license_request"></div>
    <div id="license_request_loading" class="loader"></div>
    <br></br>
    
	<h2>Install License</h2>
    <form id="licenseinstallform">
        <!--The license (string, required)-->
        <textarea style="height:200px; width:600px;" name="license" id="license" placeholder="license" value=""></textarea>
